            ...
            <div class="carousel-item active">
              ...
              <div class="carousel-caption">
                ...
                <div>
                  ...
                  <a href="../imagenes/Malicia-Canteño-CV.pdf" target:"blank"><button type="button" id="descargar-cv" class="btn btn-outline-warning">Descargar cv <i class="fas fa-angle-double-down"></i></button></a>
                </div>
              </div>
            </div>
