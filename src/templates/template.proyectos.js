    ...
    <div class="work">
      <div class="container-cards">
        ...
        <div class="card">
          ...
          <div class="center">
            <h1 class="card-title">Reto Comunal en la hackaton TFL19<br><span class="card-span">Comunal 2°do puesto</span></h1>
            <p class="card-text">Web App para el office manager donde podra visualizar los visitantes registrados del día a día, y donde podra filtrar datos, realizar un registro manual y hacer una invitación personalizada
