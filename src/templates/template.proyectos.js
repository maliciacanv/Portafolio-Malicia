  ...
  const templateProyectos = `
    <div class="work">
      <div class="container-cards">
          ...
          <div class="details">
            <div class="center">
              ...
              a mayor y por el tiempo de duración de cada tour.</p>
                <p class="card-subtext">Tecnología utilizada: Libreria React js , react hooks, Api rest, Fetch, bootstrap 4, Sass, lazy loading.</p>
                <ul class="card-list">
        ...
        <div class="card">
          ...
          <div class="details">
            <div class="center">
              ...
              <p class="card-subtext">Tecnología utilizada: Framework Angular 7, TypeScript, CSS 3, Bootstrap 4.</p>
              <ul class="card-list">
        ...
        <div class="card">
          ...
          <div class="center">
            ...
            <p class="card-subtext">Tecnología utilizada: Framework Angular 7, CSS 3, Bootstrap 4.</p>
            <ul class="card-list">
        ...
        <div class="card">
          ...
          <div class="center">
            ...
            <p class="card-text">El reto Burger Queen, es individual y fue desarrollado con Framework Angular, la web app es para un pequeño restaurante de hamburguesas, 
              ...
              <p class="card-subtext">Tecnología utilizada: Framework Angular 7, Firebase Cloud Firestore, TypeScript, Bootstrap 4, Testing con Karma.</p>
            <ul class="card-list">
        ...
        <div class="center">
          ...
          <p class="card-text">El reto Markdown Links, es individual y la tarea es crear una librería para programadores, que cumple la función de analizar la ruta ingresada e identificar los archivos
            ...
            <p class="card-subtext">Tecnología utilizada: Node js, Librería Fetch, JavaScript, Funciones Asíncronas Promesas, Testing.</p>
          <ul class="card-list">
      ...
      <div class="center">
        ...
        <p class="card-text">El reto Red Social, esta conformado por 3 personas. Despues de una encuesta online a 20 personas, creamos la red social llamada Agogo que tiene como finalidad que los usuarios puedean dar y recibir 
          ...
          <p class="card-subtext">Tecnología utilizada: Firebase Authentication y Cloud Firestore, HTML 5, JavaScript, CSS 3, Modules Import y export, Testing, SPA, Templates, Responsive Desing.</p>
        <ul class="card-list">
    ...
    <div class="center">
      ...
      <p class="card-text">El reto Data Lovers, esta conformado por 2 personas y la tarea es crear una página web.
        ...
        <p class="card-subtext">Tecnología utilizada: HTML 5, JavaScript, Archivo JSON, Métodos de arrays y objetos, CSS 3, Templates, Testing, Responsive Desing..</p>
      <ul class="card-list">
